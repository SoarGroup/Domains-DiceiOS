# Liar's Dice Style Guidelines

This style guide is based off of [Ray Wenderlich's Style Guideline](https://raw.githubusercontent.com/raywenderlich/swift-style-guide/master/README.markdown) and [GitHub's style guidelines](https://raw.githubusercontent.com/github/swift-style-guide/master/README.md).

Our overarching goals are conciseness, readability, and simplicity.

Liar's Dice uses swift where possible.  If you're using Obj-C, you're probably doing it wrong or don't know swift well enough.
...
* Indent using tabs with 4 spaces per tab. Be sure to set this preference in Xcode as shown below:
...
### Makes classes `final` by default

Classes should start as `final`, and only be changed to allow subclassing if a valid need for inheritance has been identified.  Even in that case, as many definitions as possibile *within* the class should be `final` as well, following the same rules.
...
Use whitespae around operators when defining them.  Instead of:
